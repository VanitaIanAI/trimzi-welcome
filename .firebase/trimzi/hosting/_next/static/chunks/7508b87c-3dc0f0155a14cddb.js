"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[609],{9762:function(e,t,r){r.d(t,{Bt:function(){return s1},EK:function(){return en},IO:function(){return sO},JU:function(){return ss},PL:function(){return sZ},QT:function(){return sX},Xo:function(){return sq},ad:function(){return sh},b9:function(){return s$},hJ:function(){return si},pl:function(){return s0}});var n,i,s,a,o=r(1480),l=r(5980),u=r(3693),h=r(9074),c=r(6552),d=r(4575);r(5566);var m=r(9109).lW;let f="@firebase/firestore",g="4.9.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rf{constructor(e,t,r,n,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=n,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){let n=new Map;return n.set(e,rg.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new rf(ei.min(),n,new ep(U),tx,tU())}}class rg{constructor(e,t,r,n,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=n,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new rg(r,t,tU(),tU(),tU())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sm{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new b(A.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Q(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sX(e){e=ee(e,sr);let t=ee(e.firestore,su);return(function(e,t,r={}){let n=new D;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new iJ({next:o=>{s.Nu(),t.enqueueAndForget(()=>ig(e,a));let l=o.docs.has(r);!l&&o.fromCache?i.reject(new b(A.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&n&&"server"===n.source?i.reject(new b(A.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new iv(new tv(r.path),s,{includeMetadataChanges:!0,qa:!0});return im(e,a)})(await i6(e),e.asyncQueue,t,r,n)),n.promise})(sc(t),e._key).then(r=>(function(e,t,r){let n=r.docs.get(t._key),i=new sJ(e);return new sW(e,i,t._key,n,new sQ(r.hasPendingWrites,r.fromCache),t.converter)})(t,e,r))}sY._jsonSchemaVersion="firestore/querySnapshot/1.0",sY._jsonSchema={type:et("string",sY._jsonSchemaVersion),bundleSource:et("string","QuerySnapshot"),bundleName:et("string"),bundle:et("string")};class sJ extends sK{constructor(e){super(),this.firestore=e}convertBytes(e){return new sd(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new sr(this.firestore,null,t)}}function sZ(e){e=ee(e,st);let t=ee(e.firestore,su),r=sc(t),n=new sJ(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new b(A.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,r={}){let n=new D;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new iJ({next:r=>{s.Nu(),t.enqueueAndForget(()=>ig(e,a)),r.fromCache&&"server"===n.source?i.reject(new b(A.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(r)},error:e=>i.reject(e)}),a=new iv(r,s,{includeMetadataChanges:!0,qa:!0});return im(e,a)})(await i6(e),e.asyncQueue,t,r,n)),n.promise})(r,e._query).then(r=>new sY(t,n,e,r)))}function s0(e,t,r){var n,i;e=ee(e,sr);let s=ee(e.firestore,su),a=(n=e.converter)?r&&(r.merge||r.mergeFields)?n.toFirestore(t,r):n.toFirestore(t):t;return i=[(function(e,t,r,n,i,s={}){let a,o;let l=e.Cc(s.merge||s.mergeFields?2:0,t,r,i);sA("Data must be an object, but it was:",l,n);let u=sC(n,l);if(s.merge)a=new eE(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=function(e,t,r){if((t=(0,h.m9)(t))instanceof sm)return t._internalPath;if("string"==typeof t)return sD(e,t);throw sk("Field path arguments must be of type string or ",e,!1,void 0,r)}(t,n,r);if(!l.contains(i))throw new b(A.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}a=new eE(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new sw(new e6(u),a,o)})(sT(s),"setDoc",e._key,a,null!==e.converter,r).toMutation(e._key,t1.none())],function(e,t){let r=new D;return e.asyncQueue.enqueueAndForget(async()=>iV(await i4(e).then(e=>e.syncEngine),t,r)),r.promise}(sc(s),i)}function s1(){return new sI("serverTimestamp")}new WeakMap,function(e=!0){y=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:r,options:n})=>{let i=t.getProvider("app").getImmediate(),s=new su(new V(t.getProvider("auth-internal")),new F(i,t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new b(A.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new eF(e.options.projectId,t)}(i,r),i);return n={useFetchStreams:e,...n},s._setSettings(n),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(f,g,void 0),(0,o.KN)(f,g,"esm2020")}()}}]);