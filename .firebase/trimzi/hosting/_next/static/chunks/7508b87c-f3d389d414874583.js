"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[609],{9762:function(e,t,r){r.d(t,{Bt:function(){return s8},EK:function(){return en},IO:function(){return sU},JU:function(){return sa},PL:function(){return s2},QT:function(){return s0},Xo:function(){return sz},ad:function(){return sd},b9:function(){return sG},cf:function(){return s6},hJ:function(){return ss},oe:function(){return s4},pl:function(){return s3}});var n,i,s,a,o=r(1480),l=r(5980),u=r(3693),h=r(9074),c=r(6552),d=r(4575);r(5566);var f=r(9109).lW;let m="@firebase/firestore",g="4.9.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r7{constructor(){this.Qr=new ev(ne.$r),this.Ur=new ev(ne.Kr)}isEmpty(){return this.Qr.isEmpty()}addReference(e,t){let r=new ne(e,t);this.Qr=this.Qr.add(r),this.Ur=this.Ur.add(r)}Wr(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.Gr(new ne(e,t))}zr(e,t){e.forEach(e=>this.removeReference(e,t))}jr(e){let t=new W(new G([])),r=new ne(t,e),n=new ne(t,e+1),i=[];return this.Ur.forEachInRange([r,n],e=>{this.Gr(e),i.push(e.key)}),i}Jr(){this.Qr.forEach(e=>this.Gr(e))}Gr(e){this.Qr=this.Qr.delete(e),this.Ur=this.Ur.delete(e)}Hr(e){let t=new W(new G([])),r=new ne(t,e),n=new ne(t,e+1),i=tq();return this.Ur.forEachInRange([r,n],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new ne(e,0),r=this.Qr.firstAfterOrEqual(t);return null!==r&&e.isEqual(r.key)}}class ne{constructor(e,t){this.key=e,this.Yr=t}static $r(e,t){return W.comparator(e.key,t.key)||U(e.Yr,t.Yr)}static Kr(e,t){return U(e.Yr,t.Yr)||W.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function s0(e){e=ee(e,sn);let t=ee(e.firestore,sc);return(function(e,t,r={}){let n=new D;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new iZ({next:o=>{s.Nu(),t.enqueueAndForget(()=>ip(e,a));let l=o.docs.has(r);!l&&o.fromCache?i.reject(new b(A.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&n&&"server"===n.source?i.reject(new b(A.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new i_(t_(r.path),s,{includeMetadataChanges:!0,qa:!0});return ig(e,a)})(await i9(e),e.asyncQueue,t,r,n)),n.promise})(sf(t),e._key).then(r=>s5(t,e,r))}sZ._jsonSchemaVersion="firestore/querySnapshot/1.0",sZ._jsonSchema={type:et("string",sZ._jsonSchemaVersion),bundleSource:et("string","QuerySnapshot"),bundleName:et("string"),bundle:et("string")};class s1 extends sH{constructor(e){super(),this.firestore=e}convertBytes(e){return new sm(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new sn(this.firestore,null,t)}}function s2(e){e=ee(e,sr);let t=ee(e.firestore,sc),r=sf(t),n=new s1(t);return sO(e._query),(function(e,t,r={}){let n=new D;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new iZ({next:r=>{s.Nu(),t.enqueueAndForget(()=>ip(e,a)),r.fromCache&&"server"===n.source?i.reject(new b(A.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(r)},error:e=>i.reject(e)}),a=new i_(r,s,{includeMetadataChanges:!0,qa:!0});return ig(e,a)})(await i9(e),e.asyncQueue,t,r,n)),n.promise})(r,e._query).then(r=>new sZ(t,n,e,r))}function s3(e,t,r){var n;e=ee(e,sn);let i=ee(e.firestore,sc),s=(n=e.converter)?r&&(r.merge||r.mergeFields)?n.toFirestore(t,r):n.toFirestore(t):t;return s9(i,[(function(e,t,r,n,i,s={}){let a,o;let l=e.Cc(s.merge||s.mergeFields?2:0,t,r,i);sD("Data must be an object, but it was:",l,n);let u=sA(n,l);if(s.merge)a=new eE(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=function(e,t,r){if((t=(0,h.m9)(t))instanceof sg)return t._internalPath;if("string"==typeof t)return sR(e,t);throw sx("Field path arguments must be of type string or ",e,!1,void 0,r)}(t,n,r);if(!l.contains(i))throw new b(A.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}a=new eE(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new s_(new e6(u),a,o)})(sS(i),"setDoc",e._key,s,null!==e.converter,r).toMutation(e._key,t2.none())])}function s4(e){return s9(ee(e.firestore,sc),[new rn(e._key,t2.none())])}function s6(e,...t){let r,n,i;e=(0,h.m9)(e);let s={includeMetadataChanges:!1,source:"default"},a=0;"object"!=typeof t[0]||sh(t[a])||(s=t[a++]);let o={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(sh(t[a])){let e=t[a];t[a]=e.next?.bind(e),t[a+1]=e.error?.bind(e),t[a+2]=e.complete?.bind(e)}if(e instanceof sn)n=ee(e.firestore,sc),i=t_(e._key.path),r={next:r=>{t[a]&&t[a](s5(n,e,r))},error:t[a+1],complete:t[a+2]};else{let s=ee(e,sr);n=ee(s.firestore,sc),i=s._query;let o=new s1(n);r={next:e=>{t[a]&&t[a](new sZ(n,o,s,e))},error:t[a+1],complete:t[a+2]},sO(e._query)}return function(e,t,r,n){let i=new iZ(n),s=new i_(t,i,r);return e.asyncQueue.enqueueAndForget(async()=>ig(await i9(e),s)),()=>{i.Nu(),e.asyncQueue.enqueueAndForget(async()=>ip(await i9(e),s))}}(sf(n),i,o,r)}function s9(e,t){return function(e,t){let r=new D;return e.asyncQueue.enqueueAndForget(async()=>iL(await i6(e).then(e=>e.syncEngine),t,r)),r.promise}(sf(e),t)}function s5(e,t,r){let n=r.docs.get(t._key),i=new s1(e);return new sX(e,i,t._key,n,new sY(r.hasPendingWrites,r.fromCache),t.converter)}function s8(){return new sC("serverTimestamp")}new WeakMap,function(e=!0){y=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:r,options:n})=>{let i=t.getProvider("app").getImmediate(),s=new sc(new V(t.getProvider("auth-internal")),new F(i,t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new b(A.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new eF(e.options.projectId,t)}(i,r),i);return n={useFetchStreams:e,...n},s._setSettings(n),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,g,void 0),(0,o.KN)(m,g,"esm2020")}()}}]);